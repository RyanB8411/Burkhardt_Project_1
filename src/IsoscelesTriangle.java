 ...
 * UMGC CMSC 330
 * Project 1
 * Class that extends solid polygon that will call Super color and set the vertex count to 3. It takes a Point
 * at the top center and goes down the height of y as well as half to the left and half to the right to complete
 * the points. Finally it calls the createPolygon to draw the isosceles triangle on the screen and displays a solid isosceles triangle
...
class IsoscelesTriangle extends SolidPolygon {
    ...
    //and different vertex count but same input constructors.
